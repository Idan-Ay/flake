...
c.colors.completion.category.fg = fg_selection

# Background color of the completion widget category headers.
c.colors.completion.category.bg = bg_lightest

# Top border color of the completion widget category headers.
c.colors.completion.category.border.top = bg_accent

# Bottom border color of the completion widget category headers.
c.colors.completion.category.border.bottom = bg_accent
...
c.colors.contextmenu.disabled.bg = bg_lighter_transparent

# Foreground color of disabled items in the context menu.
c.colors.contextmenu.disabled.fg = fg_disabled

# Background color of the context menu. If set to null, the Qt default is used.
c.colors.contextmenu.menu.bg = bg_default_transparent
...
c.colors.downloads.bar.bg = bg_default_transparent

# Color gradient start for download text.
c.colors.downloads.start.fg = bg_default_transparent

# Color gradient start for download backgrounds.
c.colors.downloads.start.bg = bg_insert_mode

# Color gradient end for download text.
c.colors.downloads.stop.fg = bg_default_transparent
...
c.colors.hints.fg = bg_default_transparent
...
c.colors.keyhint.bg = bg_default_transparent

# Foreground color of an error message.
c.colors.messages.error.fg = bg_default_transparent
...
c.colors.messages.warning.fg = bg_default_transparent
...
c.colors.messages.info.bg = bg_default_transparent

# Border color of an info message.
c.colors.messages.info.border = bg_default_transparent

# Foreground color for prompts.
c.colors.prompts.fg = fg_default

# Border used around UI elements in prompts.
c.colors.prompts.border = bg_default_transparent

# Background color for prompts.
c.colors.prompts.bg = bg_default_transparent
...
c.colors.statusbar.normal.bg = bg_default_transparent
...
c.colors.statusbar.passthrough.fg = bg_default_transparent

# Background color of the statusbar in passthrough mode.
c.colors.statusbar.passthrough.bg = bg_passthrough_mode

# Foreground color of the statusbar in private browsing mode.
c.colors.statusbar.private.fg = bg_default_transparent

# Background color of the statusbar in private browsing mode.
c.colors.statusbar.private.bg = bg_lighter_transparent

# Foreground color of the statusbar in command mode.
c.colors.statusbar.command.fg = fg_default

# Background color of the statusbar in command mode.
c.colors.statusbar.command.bg = bg_default_transparent

# Foreground color of the statusbar in private browsing + command mode.
c.colors.statusbar.command.private.fg = fg_default

# Background color of the statusbar in private browsing + command mode.
c.colors.statusbar.command.private.bg = bg_default_transparent

# Foreground color of the statusbar in caret mode.
c.colors.statusbar.caret.fg = bg_default_transparent

# Background color of the statusbar in caret mode.
c.colors.statusbar.caret.bg = bg_warning

# Foreground color of the statusbar in caret mode with a selection.
c.colors.statusbar.caret.selection.fg = bg_default_transparent
...
c.colors.tabs.bar.bg = bg_default_transparent
...
c.colors.tabs.odd.bg = none

# Foreground color of unselected even tabs.
c.colors.tabs.even.fg = fg_default

# Background color of unselected even tabs.
c.colors.tabs.even.bg = bg_lighter_transparent
